...
import {
  ...
  ChevronLeft, ChevronRight, Package, AlertCircle, TrendingUp
} from "lucide-react";
...
export default function AccessoryDetailModal({ isOpen, onClose, item }) {
  ...
  const discount = item.ownerPrice && item.customerPrice
    ? Math.round(((parseFloat(item.customerPrice) - parseFloat(item.ownerPrice)) / parseFloat(item.customerPrice)) * 100)
    : 0;
              ...
              <div className="max-w-6xl mx-auto flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-600 text-xs mt-1">Auto Parts & Accessories</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                    ...
                    {item.medias && item.medias.length > 0 && !imgError ? (
                      <>
                        <img
                          ...
                          alt={`${item.title} - View ${imageIndex + 1}`}
                ...
                <div className="lg:col-span-3 space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-teal-50 rounded-2xl p-6 border border-blue-200">
                    ...
                    <div className="text-4xl font-black text-blue-700 mb-2">{formatPrice(item.ownerPrice)}</div>
                    {discount > 0 && (
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white border border-blue-100 rounded-xl p-4">
                      ...
                      <div className="text-blue-950 font-bold text-sm line-clamp-2">{item.title || "—"}</div>
                    </div>
