    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            <h3 className="text-blue-950 font-black text-sm">{car.name || "Car Listing"}</h3>
            <p className="text-blue-600/60 text-xs">{car.brandName || "Brand"} · {car.model || "Model"}</p>
          </div>
        </div>

        {car.user && (
          <div className="bg-blue-50 rounded-2xl p-4 mb-4">
            <p className="text-blue-800 font-bold text-sm mb-1">{car.user.shopName || car.user.name}</p>
            {car.user.address && <p className="text-blue-600/60 text-xs mb-2 flex items-center gap-1"><MapPin size={11} />{car.user.address}</p>}
            <a
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      {pagination && (
                        <p className="text-blue-500 text-xs">{pagination.totalRecords} cars found</p>
                      )}
                    </div>
                  </div>
            ...
            <div className="flex-1 px-4 sm:px-6 py-6 max-w-7xl mx-auto w-full">
              ...
              {!loading && error && (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <p className="text-blue-950 font-bold text-lg mb-1">Failed to load cars</p>
              ...
              {!loading && !error && filtered.length === 0 && (
                <div className="flex flex-col items-center justify-center py-20 text-center">
                  ...
                  <p className="text-blue-950 font-bold text-lg mb-1">No cars found</p>
