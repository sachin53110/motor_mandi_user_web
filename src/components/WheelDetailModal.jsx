              ...
              <div className="max-w-6xl mx-auto flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-600 text-xs mt-1">{item.carCompany ? `For ${item.carCompany}` : "Premium Wheels"}</p>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div className="lg:col-span-3 space-y-6">
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl p-6 border border-emerald-200">
                    ...
                    <p className="text-emerald-600/70 text-sm">Price per wheel</p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white border border-emerald-100 rounded-xl p-4">
                      ...
                      <div className="text-emerald-950 font-bold text-lg">{item.stock || "—"} pcs</div>
                    </div>
                    ...
                    {item.carCompany && (
                      <div className="bg-white border border-emerald-100 rounded-xl p-4">
                        <div className="text-emerald-600/60 text-xs font-semibold mb-1">Compatible With</div>
                        <div className="text-emerald-950 font-bold text-lg">{item.carCompany}</div>
                      </div>
                    )}
                  </div>
